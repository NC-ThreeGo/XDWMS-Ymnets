	...
	public class Virtual_WMS_AIBLL
	{
        ...
        public virtual WMS_AIModel GetById(object id)
        {
            if (IsExists(id))
            {
				...
				model.BoxNum = entity.BoxNum;
				model.ArrivalNum = entity.ArrivalNum;
				...
				model.QualifyNum = entity.QualifyNum;
				model.NoQualifyNum = entity.NoQualifyNum;
        ...
        public virtual bool CheckImportData(string fileName, List<WMS_AIModel> list,ref ValidationErrors errors )
        {
            ...
            //对应列头
				 ...
				 excelFile.AddMapping<WMS_AIModel>(x => x.InStoreMan, "InStoreMan");
            ...
            foreach (var row in excelContent)
            {
                ...
                var entity = new WMS_AIModel();
				  ...
				  entity.ArrivalNum = row.ArrivalNum;
				  ...
				  entity.QualifyNum = row.QualifyNum;
				  entity.NoQualifyNum = row.NoQualifyNum;
