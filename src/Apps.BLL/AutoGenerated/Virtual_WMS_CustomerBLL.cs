...
{
	public partial class WMS_CustomerBLL: Virtual_WMS_CustomerBLL,IWMS_CustomerBLL
	{
        

	}
	public class Virtual_WMS_CustomerBLL
	{
        [Dependency]
        public IWMS_CustomerRepository m_Rep { get; set; }

		public virtual List<WMS_CustomerModel> GetList(ref GridPager pager, string queryStr)
        {
            ...
            if (!string.IsNullOrWhiteSpace(queryStr))
            {
                queryData = m_Rep.GetList(
								...
								a=>a.CustomerCode.Contains(queryStr)
								|| a.CustomerShortName.Contains(queryStr)
								|| a.CustomerName.Contains(queryStr)
								|| a.CustomerType.Contains(queryStr)
		...
		public virtual List<WMS_CustomerModel> GetListByUserId(ref GridPager pager, string userId,string queryStr)
		{
			return new List<WMS_CustomerModel>();
		}
		
		public virtual List<WMS_CustomerModel> GetListByParentId(ref GridPager pager, string queryStr,object parentId)
        {
			return new List<WMS_CustomerModel>();
		}

        public virtual List<WMS_CustomerModel> CreateModelList(ref IQueryable<WMS_Customer> queryData)
        {
        ...
        public virtual bool Create(ref ValidationErrors errors, WMS_CustomerModel model)
        {
            try
            {
        ...
        /// 保存数据
        /// </summary>
        public virtual void SaveImportData(IEnumerable<WMS_CustomerModel> list)
        {
            try
            {
