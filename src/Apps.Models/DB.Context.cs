...
namespace Apps.Models
{
    ...
    public partial class DBContainer : DbContext
    {
        ...
        public virtual DbSet<WMS_ReturnOrder_D> WMS_ReturnOrder_D { get; set; }
        public virtual DbSet<WMS_Inventory_H> WMS_Inventory_H { get; set; }
        ...
        public virtual int P_WMS_ConfirmSaleOrder(string userId, string sellBillNum, ObjectParameter returnValue)
        {
            var userIdParameter = userId != null ?
                new ObjectParameter("UserId", userId) :
                new ObjectParameter("UserId", typeof(string));
        ...
        public virtual int P_WMS_PrintSaleOrder(string userId, string saleBillNum, Nullable<int> id, ObjectParameter sellBillNum, ObjectParameter returnValue)
        {
            ...
            var saleBillNumParameter = saleBillNum != null ?
        ...
        public virtual int P_WMS_CreateBatchReturnInspection(string userId, string jsonReturnInspection, ObjectParameter returnInspectionNum, ObjectParameter returnValue)
        {
            var userIdParameter = userId != null ?
                new ObjectParameter("UserId", userId) :
                new ObjectParameter("UserId", typeof(string));
    
            var jsonReturnInspectionParameter = jsonReturnInspection != null ?
                new ObjectParameter("JsonReturnInspection", jsonReturnInspection) :
                new ObjectParameter("JsonReturnInspection", typeof(string));
