...
namespace Apps.Models.WMS
{
	...
	public partial class WMS_Feed_ListModel:Virtual_WMS_Feed_ListModel
	{
		
	}
	public class Virtual_WMS_Feed_ListModel
	{
		[Display(Name = "未设置")]
		public virtual int Id { get; set; }
		[Display(Name = "投料单号（业务）")]
		public virtual string FeedBillNum { get; set; }
		[Display(Name = "投料单号（系统）")]
		public virtual string ReleaseBillNum { get; set; }
		[Display(Name = "投料部门")]
