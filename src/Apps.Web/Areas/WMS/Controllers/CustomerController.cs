    ...
    public class CustomerController : BaseController
    {
        ...
        public JsonResult Create(WMS_CustomerModel model)
        {
            ...
            if (model != null && ModelState.IsValid)
            {
                ...
                {
                    LogHandler.WriteServiceLog(GetUserId(), "Id" + model.Id + ",CustomerCode" + model.CustomerCode, "成功", "创建", "WMS_Customer");
                ...
                else
                {
                    ...
                    LogHandler.WriteServiceLog(GetUserId(), "Id" + model.Id + ",CustomerCode" + model.CustomerCode + "," + ErrorCol, "失败", "创建", "WMS_Customer");
        ...
        public JsonResult Edit(WMS_CustomerModel model)
        {
            ...
            if (model != null && ModelState.IsValid)
            {
                ...
                {
                    LogHandler.WriteServiceLog(GetUserId(), "Id" + model.Id + ",CustomerCode" + model.CustomerCode, "成功", "修改", "WMS_Customer");
                    return Json(JsonHandler.CreateMessage(1, Resource.EditSucceed));
                }
                else
                {
                    string ErrorCol = errors.Error;
                    LogHandler.WriteServiceLog(GetUserId(), "Id" + model.Id + ",CustomerCode" + model.CustomerCode + "," + ErrorCol, "失败", "修改", "WMS_Customer");
        ...
        public ActionResult Delete(long id)
        {
            if(id!=0)
            {
                ...
                {
                    LogHandler.WriteServiceLog(GetUserId(), "Id:" + id, "成功", "删除", "WMS_Customer");
                    return Json(JsonHandler.CreateMessage(1, Resource.DeleteSucceed));
                }
                else
                {
                    string ErrorCol = errors.Error;
                    LogHandler.WriteServiceLog(GetUserId(), "Id" + id + "," + ErrorCol, "失败", "删除", "WMS_Customer");
        ...
        public ActionResult Import(string filePath)
        {
            ...
            {
                 LogHandler.WriteImportExcelLog(GetUserId(), "WMS_Customer", filePath.Substring(filePath.LastIndexOf('/') + 1), filePath, "导入成功");
                 return Json(JsonHandler.CreateMessage(1, Resource.InsertSucceed, filePath));
            }
            else
            {
                 LogHandler.WriteImportExcelLog(GetUserId(), "WMS_Customer", filePath.Substring(filePath.LastIndexOf('/') + 1), filePath, "导入失败");
