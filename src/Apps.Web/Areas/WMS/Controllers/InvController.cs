    ...
    public class InvController : BaseController
    {
        ...
        public JsonResult Create(WMS_InvModel model)
        {
            ...
            if (model != null && ModelState.IsValid)
            {
                ...
                {
                    LogHandler.WriteServiceLog(GetUserId(), "Id" + model.Id + ",InvId" + model.InvId, "成功", "创建", "WMS_Inv");
                    return Json(JsonHandler.CreateMessage(1, Resource.InsertSucceed));
                }
                else
                {
                    string ErrorCol = errors.Error;
                    LogHandler.WriteServiceLog(GetUserId(), "Id" + model.Id + ",InvId" + model.InvId + "," + ErrorCol, "失败", "创建", "WMS_Inv");
        ...
        public JsonResult Edit(WMS_InvModel model)
        {
            if (model != null && ModelState.IsValid)
            {
                ...
                {
                    LogHandler.WriteServiceLog(GetUserId(), "Id" + model.Id + ",InvId" + model.InvId, "成功", "修改", "WMS_Inv");
                    return Json(JsonHandler.CreateMessage(1, Resource.EditSucceed));
                }
                else
                {
                    string ErrorCol = errors.Error;
                    LogHandler.WriteServiceLog(GetUserId(), "Id" + model.Id + ",InvId" + model.InvId + "," + ErrorCol, "失败", "修改", "WMS_Inv");
        ...
        public ActionResult Delete(long id)
        {
            if(id!=0)
            {
                ...
                {
                    LogHandler.WriteServiceLog(GetUserId(), "Id:" + id, "成功", "删除", "WMS_Inv");
                    return Json(JsonHandler.CreateMessage(1, Resource.DeleteSucceed));
                }
                else
                {
                    string ErrorCol = errors.Error;
                    LogHandler.WriteServiceLog(GetUserId(), "Id" + id + "," + ErrorCol, "失败", "删除", "WMS_Inv");
        ...
        public ActionResult Import(string filePath)
        {
            ...
            {
                 LogHandler.WriteImportExcelLog(GetUserId(), "WMS_Inv", filePath.Substring(filePath.LastIndexOf('/') + 1), filePath, "导入成功");
                 return Json(JsonHandler.CreateMessage(1, Resource.InsertSucceed, filePath));
            }
            else
            {
                 LogHandler.WriteImportExcelLog(GetUserId(), "WMS_Inv", filePath.Substring(filePath.LastIndexOf('/') + 1), filePath, "导入失败");
