...
namespace Apps.DAL.WMS
{
    ...
    {
        public string PrintSaleOrder(string opt, string saleBillNum, ref string sellBillNum)
        {
            ...
            Context.P_WMS_PrintSaleOrder(opt, saleBillNum, paramrSellBillNum, returnValue);
