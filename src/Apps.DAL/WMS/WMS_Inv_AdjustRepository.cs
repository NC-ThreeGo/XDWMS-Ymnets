...
namespace Apps.DAL.WMS
{
    ...
    {
        public string CreateInvAdjust(string opt, int? partId, int? invId, string lot, decimal? adjustQty, string adjustType, string remark, ref string invAdjustBillNum)
        {
            ...
            Context.P_WMS_InvAdjust(opt, partId, invId, lot, adjustQty, adjustType, remark, invAdjustBillNumP, returnValue);
