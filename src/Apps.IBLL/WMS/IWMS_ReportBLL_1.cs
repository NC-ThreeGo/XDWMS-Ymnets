...
namespace Apps.IBLL.WMS
{
    public partial interface IWMS_ReportBLL
    {
        ...
        List<WMS_AIModel> SupplierDelivery(ref GridPager pager, string po, string suppliername, string partcode, string partname, DateTime beginDate, DateTime endDate, string deliveryType);
