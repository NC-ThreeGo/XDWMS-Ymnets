...
{
    public partial interface IWMS_ReInspectBLL
    {
         /// <summary>
         ...
         void AdditionalCheckExcelData(ref WMS_ReInspectModel model);
         ...
         List<WMS_ReInspectModel> GetListByWhere(ref GridPager pager, string where);
    }
}
