...
{
    public partial interface IWMS_ReportParamBLL
    {
         /// <summary>
         ...
         void AdditionalCheckExcelData(ref WMS_ReportParamModel model);
         ...
         List<WMS_ReportParamModel> GetListByWhere(ref GridPager pager, string where);
    }
}
