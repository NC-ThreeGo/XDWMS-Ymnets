...
{
    public partial interface IWMS_Inv_AdjustBLL
    {
         /// <summary>
         ...
         void AdditionalCheckExcelData(ref WMS_Inv_AdjustModel model);
         ...
         List<WMS_Inv_AdjustModel> GetListByWhere(ref GridPager pager, string where);
    }
}
