...
{
    public partial interface IWMS_InvRecordBLL
    {
         /// <summary>
         ...
         void AdditionalCheckExcelData(ref WMS_InvRecordModel model);
         ...
         List<WMS_InvRecordModel> GetListByWhere(ref GridPager pager, string where);
    }
}
