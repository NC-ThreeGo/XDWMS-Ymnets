...
{
    public partial interface ISysParamBLL
    {
         /// <summary>
         ...
         void AdditionalCheckExcelData(ref SysParamModel model);
         ...
         List<SysParamModel> GetListByWhere(ref GridPager pager, string where);    }
}
